...
<body>
    ...
    <header class="roriri-topbar">
        ...
        <div class="d-flex align-items-center gap-3">
            <!-- Theme Toggle Icon -->
            <button type="button" class="btn btn-sm rounded-circle" title="Toggle Dark/Light Theme" id="clientThemeToggleBtn" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: #ffffff; border: 1px solid #e2e8f0; color: #475569;">
            ...
            <div class="dropdown">
                <a href="#" class="user-profile-badge" data-bs-toggle="dropdown">
                    ...
                    <div class="d-flex flex-column text-start">
                        <span class="fw-bold small" style="color: #0f172a;">{{ Auth::guard('client')->user()->name ?? 'Client User' }}</span>
                        <span style="font-size: 11px; color: #64748b;">{{ Auth::guard('client')->user()->client->client_company ?? 'Client Organization' }}</span>
                    </div>
                </a>
    ...
    <script>
        function applySavedTheme() {
            ...
            const themeIcon = document.getElementById('clientThemeIcon');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            applySavedTheme();
            const themeToggleBtn = document.getElementById('clientThemeToggleBtn');
            if (themeToggleBtn) {
