    ...
    <div class="card-body p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mt-2 mb-0">Fill in the client details and send a Verification OTP to their email. Once verified, manually set their password and finalize their account.</p>
            </div>
        ...
        <form id="staffClientForm" action="{{ route('staff.clients.store') }}" method="POST" autocomplete="off">
            ...
            <div id="staffVerificationSection" class="p-4 rounded-3 mb-4 border border-primary-subtle bg-light">
                ...
                <p class="text-muted small mb-3">
                    Click <strong>"Send OTP"</strong> above. A 6-digit code will be sent to the client. Enter the OTP code below and set the password manually.
                </p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="input-group">
                            <input type="password" name="password" id="staffClientPasswordField" class="form-control bg-white" placeholder="Type custom password (min 6 chars)" minlength="6" required>
                            <button type="button" class="btn btn-outline-secondary" id="btnStaffTogglePassword">
                                <i class="fa-regular fa-eye"></i>
                            </button>
                        </div>
                        <div class="form-text small text-muted">Manually assign the password. The client receives their confirmation email with login link upon account creation.</div>
                    </div>
                </div>
            </div>
