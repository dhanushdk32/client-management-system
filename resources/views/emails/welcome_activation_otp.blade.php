...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f4f6fb; margin: 0; padding: 30px 15px;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06); border: 1px solid #e2e8f0;">
        ...
        <div style="background: linear-gradient(135deg, #1f0038 0%, #2d084e 100%); padding: 35px 30px; text-align: center; color: #ffffff;">
            ...
            <p style="margin: 8px 0 0 0; font-size: 15px; color: #fed7d2; opacity: 0.95;">Account Verification Code</p>
        </div>
        ...
        <div style="padding: 35px 30px;">
            ...
            <!-- OTP Code Box -->
            <div style="background-color: #f8fafc; border: 2px dashed #fb5544; border-radius: 12px; padding: 25px; text-align: center; margin: 30px 0;">
                ...
                <span style="font-size: 38px; font-weight: 800; letter-spacing: 8px; color: #fb5544; font-family: monospace;">{{ $otpCode }}</span>
